...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [139 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		i32 2126336, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 15050624; uint32_t buffer_offset
	}, ; 136: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 22088, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 15221632; uint32_t buffer_offset
	}, ; 137: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2037760, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 15243720; uint32_t buffer_offset
	} ; 138: Mono.Android
], align 4

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 17281480, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [17281480 x i8] zeroinitializer, align 1
